...
#
# Figures produced:
#   ../figures/vi_vs_nuts_var3.png         (3D VAR(2), Fig. 2)
#   ../figures/triangle_noise4a_eta0p5.png (LISA, Fig. 3 left)
#   ../figures/triangle_noise5a_eta0p5.png (LISA, Fig. 3 right)
#   ../figures/lisa_eta_sweep.pdf          (LISA eta sweep, Fig. 4)
#
...
echo "[1/3] 3D VAR(2) -> figures/vi_vs_nuts_var3.png"
...
if [ -f "${OVERLAY}" ]; then
    ...
    "${PYTHON}" "${HERE}/plot_var3.py" \
        --idata "${OVERLAY}" \
        --output "${FIGURES}/vi_vs_nuts_var3.png"
else
...
echo "[2/3] LISA triangle plots -> figures/triangle_noise{4a,5a}_eta0p5.png"
