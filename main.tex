...
\begin{document}
	...
	\begin{abstract}
		...
		frequency-varying Cholesky factor with log-diagonal terms, enforcing
	...
	coefficients, with the smoothing parameter integrated out. Applied to
	...
	\citep{maturana-russel_bayesian_2021}, and recent LISA-specific work has introduced log-spline
	...
	These univariate approaches model each channel independently. The
	...
	estimation \citep{yi2025biases,yi2026biases2,chandramouli2024grtests}.
	Modelling $\S(f)$ nonparametrically therefore requires a
	parametrisation that guarantees Hermitian positive definiteness at every
	frequency while allowing each element to vary smoothly with frequency.

	In this paper we extend the Bayesian P-spline PSD framework to the
	...
	estimation problem into $p$ independent regression blocks that can be
	sampled in parallel. 
	...
	apply unchanged. The VAR(2) simulation study of
	...
	from summing $N_{b}$ independent single-block periodogram
	contributions:
	\[
	...
	$\u^{(k)}_{\nu}=\sqrt{\lambda^{(k)}_{\nu}}\,\v^{(k)}_{\nu}$.
	Substituting into the trace yields the eigenvector form
	\begin{equation}
		\label{eq:log-like}
		\mathcal{L}_{b}(\d|\S)
	...
	$N_{c}$ coarse bins, $K$ basis functions per bin, and $p^{2}$ spline
	...
	$\hat{R}<1.01$, that the bulk and tail effective sample sizes both
	...
	\subsection{3D VAR(2) simulation study}
	...
	Off-diagonal coverage is computed separately for the real and
	imaginary parts of each cross-spectrum. We use $\alpha=0.9$
	throughout.
    ...
    \begin{NiceTabular}{ccccccc}
        ...
        \midrule
        1 & off & 8192 & $0.910 \pm 0.031$ & $0.111 \pm 0.004$ & $21,019 \pm 2726$ & $9.61 \pm 1.76$ \\
        1 & 2 & 4096 & $0.908 \pm 0.031$ & $0.112 \pm 0.005$ & $24,057 \pm 2807$ & $9.21 \pm 1.69$ \\
        1 & 4 & 2048 & $0.910 \pm 0.030$ & $0.112 \pm 0.005$ & $26,352 \pm 3081$ & $9.03 \pm 1.56$ \\
        1 & 8 & 1024 & $0.914 \pm 0.029$ & $0.111 \pm 0.005$ & $26,640 \pm 3303$ & $8.92 \pm 1.65$ \\
        1 & 16 & 512 & $0.918 \pm 0.029$ & $0.110 \pm 0.004$ & $25,480 \pm 3525$ & $8.81 \pm 1.62$ \\
        1 & 32 & 256 & $0.917 \pm 0.030$ & $0.109 \pm 0.004$ & $24,011 \pm 3500$ & $8.82 \pm 1.70$ \\
        \midrule
        2 & off & 4096 & $0.908 \pm 0.031$ & $0.112 \pm 0.005$ & $23,938 \pm 2939$ & $9.11 \pm 1.63$ \\
        2 & 2 & 2048 & $0.911 \pm 0.030$ & $0.112 \pm 0.005$ & $26,279 \pm 2979$ & $9.03 \pm 1.72$ \\
        2 & 4 & 1024 & $0.914 \pm 0.030$ & $0.111 \pm 0.005$ & $26,405 \pm 3361$ & $8.89 \pm 1.67$ \\
        2 & 8 & 512 & $0.917 \pm 0.030$ & $0.110 \pm 0.004$ & $25,726 \pm 3461$ & $8.76 \pm 1.75$ \\
        2 & 16 & 256 & $0.917 \pm 0.031$ & $0.109 \pm 0.004$ & $23,997 \pm 3787$ & $8.81 \pm 1.69$ \\
        \midrule
        4 & off & 2048 & $0.911 \pm 0.030$ & $0.112 \pm 0.004$ & $26,053 \pm 2906$ & $9.05 \pm 1.71$ \\
        4 & 2 & 1024 & $0.914 \pm 0.029$ & $0.111 \pm 0.005$ & $26,695 \pm 3221$ & $8.84 \pm 1.64$ \\
        4 & 4 & 512 & $0.917 \pm 0.030$ & $0.110 \pm 0.004$ & $25,753 \pm 3636$ & $8.75 \pm 1.72$ \\
        4 & 8 & 256 & $0.917 \pm 0.030$ & $0.109 \pm 0.004$ & $24,036 \pm 3622$ & $8.78 \pm 1.68$ \\
        \midrule
        8 & off & 1024 & $0.914 \pm 0.030$ & $0.112 \pm 0.005$ & $26,336 \pm 3190$ & $8.89 \pm 1.65$ \\
        8 & 2 & 512 & $0.917 \pm 0.030$ & $0.111 \pm 0.005$ & $25,587 \pm 3658$ & $8.78 \pm 1.70$ \\
        8 & 4 & 256 & $0.917 \pm 0.031$ & $0.110 \pm 0.004$ & $24,000 \pm 3787$ & $8.79 \pm 1.70$ \\
        \midrule
        16 & off & 512 & $0.915 \pm 0.029$ & $0.111 \pm 0.004$ & $25,504 \pm 3431$ & $8.74 \pm 1.55$ \\
        16 & 2 & 256 & $0.917 \pm 0.030$ & $0.110 \pm 0.004$ & $23,862 \pm 3724$ & $8.84 \pm 1.68$ \\
        \bottomrule
    \end{NiceTabular}
	\end{table*}
	...
	\citep{zenodoLisaDataset}. The data were generated with
	...
	\begin{table}[H]
		...
		\caption{LISA TDI $X_{2}Y_{2}Z_{2}$ results at fixed safe-Bayes
			...
			to give $\sim 7$-day blocks: $\lfloor T/(7\,\text{d})\rfloor$);
			$N_{c}$ is the number of in-band coarse frequency bins, set
			to a target of $1024$ via the schedule of
			Section~\ref{subsec:coarse}. RIAE is the Frobenius-norm relative
			...
			pointwise relative widths of the 90\% credible bands on the
		...
		\begin{ruledtabular}
			...
			\begin{tabular}{llccccccc}
				Dataset & Duration & $N_{b}$ & $N_{c}$ & RIAE & $\Delta_{\rm PSD}$ & $\Delta_{\rm coh}$ & Runtime \\ \hline
				\texttt{noise4a} & $1$\,mo & $4$  & $1024$ & $0.0047$ & $4.6\%$ & $2.4\%$ & $274$\,s \\
				\texttt{noise4a} & $6$\,mo & $25$ & $1024$ & $0.0053$ & $1.9\%$ & $1.0\%$ & $331$\,s \\
				\texttt{noise4a} & $1$\,yr & $52$ & $1024$ & $0.0050$ & $1.2\%$ & $0.7\%$ & $1012$\,s \\
				\texttt{noise5a} & $1$\,mo & $4$  & $1024$ & ---     & $4.7\%$ & $2.4\%$ & $236$\,s \\
				\texttt{noise5a} & $6$\,mo & $25$ & $1024$ & ---     & $1.9\%$ & $1.0\%$ & $313$\,s \\
				\texttt{noise5a} & $1$\,yr & $52$ & $1024$ & ---     & $1.1\%$ & $0.6\%$ & $1149$\,s \\
			\end{tabular}
		\end{ruledtabular}
	\end{table}
	...
	assume \emph{local} stationarity: partition the mission timeline
	...
	The datasets generated are available available at the public Zenodo repository~\citeme.
