...
\begin{document}
	...
	($\mathrm{RIAE}=0.114$, coverage $87\%$), with NUTS and SVI
	...
	\begin{itemize}
		...
		$3\times3$ XYZ covariance at every frequency (implementation:
		\texttt{lisa\_logpspline/src/segwo.py}).
	\end{itemize}
	...
	$\eta=0.5$. Each block is tapered with a Tukey window
	...
	durations. All twelve runs converge cleanly ($\hat R<1.01$, no
	problematic divergences). The results split sharply along the
	...
	\begin{table*}[!htbp]
		...
		\caption{LISA TDI $X_{2}Y_{2}Z_{2}$ results at fixed safe-Bayes
			...
			of the 90\% credible band on the diagonal auto-spectra
		...
		\begin{ruledtabular}
			...
			\begin{tabular}{llccccc}
				Noise & Model & Duration & $N_{b}$ & RIAE & $\Delta_{\rm PSD}$ & Runtime \\ \hline
				\texttt{4a} & $\mathcal{H}_{AET}$ & $1$\,mo & $4$  & $4.5\!\times\!10^{-3}$ & $4.8\%$ & $117$\,s \\
				\texttt{4a} & $\mathcal{H}_{AET}$ & $6$\,mo & $25$ & $4.7\!\times\!10^{-3}$ & $1.9\%$ & $224$\,s \\
				\texttt{4a} & $\mathcal{H}_{AET}$ & $1$\,yr & $52$ & $4.4\!\times\!10^{-3}$ & $1.2\%$ & $632$\,s \\
				\texttt{4a} & $\mathcal{H}_{XYZ}$      & $1$\,mo & $4$  & $4.7\!\times\!10^{-3}$ & $4.6\%$ & $119$\,s \\
				\texttt{4a} & $\mathcal{H}_{XYZ}$      & $6$\,mo & $25$ & $5.3\!\times\!10^{-3}$ & $1.9\%$ & $181$\,s \\
				\texttt{4a} & $\mathcal{H}_{XYZ}$      & $1$\,yr & $52$ & $5.0\!\times\!10^{-3}$ & $1.2\%$ & $853$\,s \\ \hline
				\texttt{5a} & $\mathcal{H}_{AET}$ & $1$\,mo & $4$  & $2.2\!\times\!10^{-2}$ & $4.9\%$ & $119$\,s \\
				\texttt{5a} & $\mathcal{H}_{AET}$ & $6$\,mo & $25$ & $1.8\!\times\!10^{-2}$ & $1.9\%$ & $218$\,s \\
				\texttt{5a} & $\mathcal{H}_{AET}$ & $1$\,yr & $52$ & $2.2\!\times\!10^{-2}$ & $1.3\%$ & $728$\,s \\
				\texttt{5a} & $\mathcal{H}_{XYZ}$      & $1$\,mo & $4$  & $1.1\!\times\!10^{-3}$ & $4.5\%$ & $177$\,s \\
				\texttt{5a} & $\mathcal{H}_{XYZ}$      & $6$\,mo & $25$ & $9.8\!\times\!10^{-4}$ & $1.9\%$ & $245$\,s \\
				\texttt{5a} & $\mathcal{H}_{XYZ}$      & $1$\,yr & $52$ & $8.6\!\times\!10^{-4}$ & $1.3\%$ & $1089$\,s \\
			\end{tabular}
		\end{ruledtabular}
	\end{table*}
	...
	\begin{figure*}[!t]
		\centering
		\includegraphics[width=0.48\linewidth]{figures/triangle_noise4a_eta0p5.png}\hfill
		\includegraphics[width=0.48\linewidth]{figures/triangle_noise5a_eta0p5.png}
		\caption{Posterior summaries of the LISA TDI
			...
			credible bands for the auto-spectra
			$S_{XX},S_{YY},S_{ZZ}$. Lower-triangle panels show the
			coherence $|C_{ij}(f)|$ for each pair. Welch reference
			(grey) is overplotted.}
	...
	auto-spectra are recovered with sub-percent bias and CI widths that
	...
	$\sim 1.7$ at 1 year. Wall-clock runtime grows much more slowly
	...
	\begin{figure*}[!t]
		...
		\caption{Safe-Bayes $\eta$-sensitivity on the symmetric LISA
			...
			Left: median pointwise relative width of the 90\% credible
			band on the diagonal PSDs.
			Centre: coverage of the 90\% credible band; horizontal
			dashed line is the nominal $0.9$.
			Right: matrix RIAE (narrow $y$-range---RIAE varies by
	...
	Three features emerge from Figure~\ref{fig:lisa_eta_sweep}.
	...
	Third, coverage tracks CI width: at $\eta=1$ it falls well below
	nominal at all durations ($0.10$--$0.34$), while at $\eta=0.01$
	it recovers $0.86$ at $1$\,month but stalls at $0.61$--$0.67$ at
	longer durations, indicating that aggressive tempering alone cannot
	fully compensate for the model's smooth-spline bias.
